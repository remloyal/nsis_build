...
!define stack::ns_pop_back `!insertmacro stack::ns_pop_back`

!macro stack::ns_pop_back _STRING _ERR
	stack::_ns_pop_back /NOUNLOAD
	Pop ${_STRING}
	Pop ${_ERR}
!macroend


!define stack::ns_insert `!insertmacro stack::ns_insert`

!macro stack::ns_insert _STRING _INDEX _ERR
	stack::_ns_insert /NOUNLOAD `${_STRING}` `${_INDEX}`
	Pop ${_ERR}
!macroend


!define stack::ns_delete `!insertmacro stack::ns_delete`

!macro stack::ns_delete _INDEX _STRING _ERR
	stack::_ns_delete /NOUNLOAD `${_INDEX}`
	Pop ${_STRING}
	Pop ${_ERR}
!macroend
