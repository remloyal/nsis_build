...
; left logo on the Welcome page
  AnimGif::play /NOUNLOAD /HALIGN=0 /VALIGN=50 /BGCOL=${COLOR_WINDOW} "$EXEDIR\tweety.gif"
...
; header image
  ...
  AnimGif::play /NOUNLOAD /HWND=$0 /HALIGN=0 /BGCOL=${COLOR_WINDOW} /FIT=HEIGHT "$EXEDIR\sonic.gif"
