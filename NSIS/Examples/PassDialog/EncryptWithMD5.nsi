...
Function InputBoxPageShow
 ...
 PassDialog::InitDialog InputBox /HEADINGTEXT "The MD5 DLL plugin is required. You can download it from the NSIS Wiki." /BOX "String:" "$R1" 0 /BOXRO "MD5 Checksum:" "$R2" 0
  Pop $R3 # Page HWND
 PassDialog::Show
