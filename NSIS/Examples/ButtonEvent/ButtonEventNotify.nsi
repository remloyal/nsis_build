...
Function ComponentsShow
  ...
  # Create event handler for our Components page button. /NOTIFY makes
  # the button move to the next page when clicked.
  ButtonEvent::AddEventHandler ${IDC_BUTTON_ILIKECHEESE} /NOTIFY
...
# Occurs on Components page leave.
Function ComponentsLeave

  ButtonEvent::WhichButtonId
  Pop $R0
  ${Switch} $R0
    ${Case} ${IDC_BUTTON_ILIKECHEESE}
      Call ILikeCheese
      Abort
  ${EndSwitch}
