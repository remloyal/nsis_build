...
/*在这里创建窗口,以及调整窗口*/
  ...
  ; 格式:	${NSW_CreateWindow} 保存窗口句柄的变量 窗口标题 要模仿的NSIS内部对话框
	${NSW_CreateWindow} $hWNDAboutWindow "关于 $(^NameDA) v${VERSION} 汉化增强版" 1018
...
/*从这里开始, 添加你自己的控件*/
  ; 创建一个Label控件, 所支持的控件类型请查阅说明文件, 用法基本上与nsDialogs类似
	${NSW_CreateLabel} 15 8 95% 40% "简体中文增强版除了主程序的翻译之外还把主要的文档作了翻译并修正了官方\
  	版本里简体中文语言习惯用语不合适之处。单纯的使用脚本来编写安装程序对\
  	于大多数人来说不仅困难而且容易出错，为此，简体中文增强版里集成了一个\
  	...
  	积超小的补丁升级程序。另外，简体中文增强版还在官方版本的基础上集成了一些有用\
  	的插件。\
