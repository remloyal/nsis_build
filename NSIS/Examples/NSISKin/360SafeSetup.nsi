...
Function 360Safe
   ...
   ${If} $InstallState == "Cover"
	...
	NSISKin::SetControlData "Wizard_StartInstallBtn4Page2" "覆盖" "text"
   ${EndIf}
...
Function OnGlobalCancelFunc
   NSISKin::TBCIASendMessage $Dialog WM_TBCIACANCEL "360Safe安装" "确定要退出360Safe安装？"
   Pop $0
   ${If} $0 == "0"
...
Function OnChangeFunc
   ${If} $changebkimageIndex == "0"
	...
	NSISKin::SetControlData "Wizard_Background4Page3" "内嵌背景4Page3_1.png" "bkimage"
   ${Else}
        StrCpy $changebkimageIndex "0"
	NSISKin::SetControlData "Wizard_Background4Page3" "内嵌背景4Page3_2.png" "bkimage"
   ${EndIf}
...
Function OnInstallPathBrownBtnFunc
   NSISKin::SelectFolderDialog "请选择文件夹"
   Pop $installPath
...
Function un.OnChangeFunc
   ${If} $changebkimage4UninstallIndex == "0"
	...
	NSISKin::SetControlData "Wizard_BackgroundUninstallPage" "内嵌背景4Page3_1.png" "bkimage"
   ${Else}
        StrCpy $changebkimage4UninstallIndex "0"
	NSISKin::SetControlData "Wizard_BackgroundUninstallPage" "内嵌背景4Page3_2.png" "bkimage"
   ${EndIf}
FunctionEnd
