...
LangString UNINSTALL_TEXT ${LANG_SIMPCHINESE} "您确实要完全移除${PRODUCT_NAME} 及其所有的组件？"
LangString UNINSTALL_TEXT ${LANG_Spanish} "?? está seguro de que quiere eliminar por completo el ${PRODUCT_NAME} y todos sus componentes?"
...
Function un.onInit
  ...
  ; ${If} $LANGUAGE == 1034
  ;   ; 西班牙语
  ;   MessageBox MB_YESNO|MB_ICONQUESTION|MB_DEFBUTTON2 "?? está seguro de que quiere eliminar por completo el ${PRODUCT_NAME} y todos sus componentes?" IDYES un_yes  IDNO un_no
